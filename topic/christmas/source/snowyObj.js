function Snowy(options){
    ...
    function getDistance(n) {
        var s = addIn.offsetWidth > addIn.offsetHeight ? addIn.offsetWidth : addIn.offsetHeight;
    ...
    newSnow();
    init = function() {
        canvas.height = addIn.offsetHeight;
        canvas.width = addIn.offsetWidth;
